            ...
            process.nextTick(function () {
                ...
                if( mapping.outside ) {
                    ...
                    var cmds = [
                        ...
                        'wget --no-check-certificate -q -O - '  + item[mapping.linkref] 
                    ];
                    var context = this;
                    debug( cmds.join(';'));
                    exec(cmds.join(';'), function(err, out, code) {
                        ...
                        debug('after get context %s', item.guid )
                        fs.writeFile(item.guid + 'out', out)
                        //fs.writeFile(item.guid + 'code', code)
